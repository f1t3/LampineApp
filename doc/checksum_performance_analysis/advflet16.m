function f = advflet16(esnostart, esnostop, nsim)
...
results = loadres('resultsadvflet16.mat');
...
storeres('resultsadvflet16', results, esnodb, nsim, nerractual, nerrdet, nerrmiss, nerrfalse)
